...
3. **Relayers**: Run a relayer from NEAR to Calimero and another relayer from Calimero to NEAR. These relayers are responsible for relaying relevant events and blocks between the two chains.
