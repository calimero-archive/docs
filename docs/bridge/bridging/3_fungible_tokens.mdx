...
``` bash
near call wrap.testnet ft_transfer_call --args '{"receiver_id":"ft_source_connector.cali99.apptest-development.testnet","amount":"12345","msg":""}' --accountId igi.testnet --depositYocto 1 --gas 3000000000000
```
...
```
calimero cali99-calimero-testnet call wrap.ft_dest_connector.cali99.calimero.testnet withdraw --args '{"amount":"345"}' --accountId igi.testnet --depositYocto 1 --gas 300000000000000
```
...
const callWithdrawOnCalimero: FunctionCallOptions = {
  contractId: 'wrap.ft_dest_connector.cali99.calimero.testnet',
  methodName: 'withdraw',
  args: {
    amount: amount,
  },
...
Calimero:
``` bash
near view wrap.ft_dest_connector.cali99.calimero.testnet ft_balance_of --args '{"account_id":"igi.testnet"}' --nodeUrl https://api-{`$ENVIRONMENT`}.calimero.network/api/v1/shards/cali99-calimero-testnet/neard-rpc --networkId cali99-calimero-testnet
```
