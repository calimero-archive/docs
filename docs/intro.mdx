...
Smart contracts from private shards can call
into public shard to interact with those applications
Public smart contracts if setup can also call into private
shard’s contracts (extended trust model, similar to Oracles)
