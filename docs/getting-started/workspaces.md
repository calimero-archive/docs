...
:::info
Welcome to the guide on creating workspaces within your organization! Workspaces play a crucial role in managing different aspects of your projects.
:::

## Understanding Workspaces

In the Calimero console, workspaces have been introduced to facilitate running and validating the same chain by multiple entities. Each workspace is associated with a single organization and represents a distinct environment for setting up your blockchain projects. 
...
2. **Workspace Details**: Provide the following information:
...
3. **Chain Details**: Add a unique identifier and description for your chain.
...
## Creating a Professional Mainnet Workspace
...
4. **Chain Details**: Provide a unique identifier and description for your mainnet chain.
...
## Creating a Professional Testnet Workspace
