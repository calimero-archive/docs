...
:::info
Calimero Rust SDK code is similar to the NEAR Rust SDK. For more information, you can refer the [NEAR docs](https://docs.near.org/sdk/rust/introduction)
:::
...
2. Create a new **rust** project using our [quickstart guide](https://docs.near.org/develop/quickstart-guide).
3. Read our docs on **[how to write smart contracts](https://docs.near.org/develop/contracts/anatomy)**.
