...
Wrapped/bridged NFT naming is performed in the same way as FT naming so for a detailed description look at the [Fungible token documentation](./fungible_tokens#wrapped-tokens-naming).
