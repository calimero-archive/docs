...
The Fungible Token Connector consists of four contracts: `ft_connector`, `bridge_token_deployer`, `bridge_token`, and `permissions_manager`. These contracts need to be installed on both chains.
