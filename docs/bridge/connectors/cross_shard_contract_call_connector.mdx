...
:::info
Before proceeding to use the XSC connector check and fulfill the [prerequisites for using the bridge](https://docs.calimero.network/bridge/bridging/prerequisites).
:::
