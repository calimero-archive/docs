...
This guide provides step-by-step instructions on how to bridge fungible tokens from NEAR Testnet to Calimero and withdraw them back to NEAR Testnet. Before proceeding with the token bridging process, please ensure that you have met the necessary prerequisites outlined in the previous section.

## Bridging FTs from NEAR to Calimero

To bridge fungible tokens from NEAR Testnet to Calimero, follow these steps:
