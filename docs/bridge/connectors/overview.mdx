...
The Cross Shard Calls Connector enables the execution of cross-shard calls within the Calimero ecosystem. It allows users to call methods on one chain's contracts from another chain, enhancing interoperability and enabling seamless interactions between shards. 
