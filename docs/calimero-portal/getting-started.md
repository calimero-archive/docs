...
## Installing the Community Portal as a Progressive Web Application (PWA)

A Progressive Web Application (PWA) allows you to install the Community Portal on your device, providing you with a more seamless experience. This means you can access the portal without needing to open a browser every time.

### For Mobile Devices:

1. Open the [Community Portal](https://portal.calimero.network) on your mobile device's browser
...
5. The Community Portal app icon will now appear on your device's home screen, allowing you to access it just like any other app.

### For Desktop:

1. Open [Community Portal](https://portal.calimero.network) in Google Chrome.
2. Click on the **+** icon or "Install" in the address bar at the top right.
3. Confirm the installation when prompted.
4. The Community Portal app will be added to your desktop and can be accessed directly from there.
